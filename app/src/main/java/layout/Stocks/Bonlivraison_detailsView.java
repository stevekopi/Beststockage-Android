...
public class Bonlivraison_detailsView extends Fragment {
    ...
    private void fillData()
    {
        try {
            ...
            cd.sklservices.com.Beststockage.Classes.Registres.Vehicule V = vehiculeViewModel.get(bonlivraison.getVehicule_id()) ;
            Vehicule = V.getMarque()+" "+V.getMatricule() ;


            cd.sklservices.com.Beststockage.Classes.Registres.Driver D = driverViewModel.get(bonlivraison.getDriver_id()) ;

                    Driver = D.getName() ;


            cd.sklservices.com.Beststockage.Classes.Registres.Convoyeur C = convoyeurViewModel.get(bonlivraison.getConvoyeur_id()) ;
            Convoyeur = C.getName() ;


            cd.sklservices.com.Beststockage.Classes.Registres.Delegue Del = delegueViewModel.get(bonlivraison.getDelegue_id()) ;
            Delegue = Del.getName() ;
