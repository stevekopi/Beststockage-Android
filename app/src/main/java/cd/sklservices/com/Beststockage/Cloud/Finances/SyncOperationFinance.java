                    ...
                    if (output.contains("AddingDate")){
                        try {
                            ...
                            for (int k=0;k<instances.length();k++){
                                ...
                                OperationFinance instance=new OperationFinance(id,agence_id,UserId,fournisseur_id,devise_id,LocalDeviseId,ConvertDeviseId,categorie
                                        ,date,type,montant,MontantLocal,ConvertedAmount,observation,insert_mode,isCaisseCheched,isStockChecked,isUserConfirmed,
