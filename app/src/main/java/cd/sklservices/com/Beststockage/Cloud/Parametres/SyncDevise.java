                    ...
                    if (output.contains("AddingDate")){
                        try {
                            ...
                            for (int k=0;k<instances.length();k++){
                                ...
                                String Symbole =info.getString("Symbole");
                                int IsLocal =info.getInt("IsLocal");
                                int IsDefault =info.getInt("IsDefault");
                                int IsDefaultConverter =info.getInt("IsDefaultConverter");
                                ...
                                Devise devise=new Devise(Id,Code,Designation,Description,Symbole,IsLocal,IsDefault,IsDefaultConverter,adding_date,updated_date,sync_pos,pos) ;
